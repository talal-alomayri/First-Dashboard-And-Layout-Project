...
export default function ProjectCard(){
    return(
        <div className="bg-white rounded-md mx-3 shadow-2xl">
          ...
          <table className="text-xs w-full table-fixed">
           <thead className="bg-stone-200">
            <tr className="text-left">
              <th className="p-3 md:text-xs text-[10px] font-semibold tracking-wide">Name</th>
              <th className="p-3 md:text-xs text-[10px] font-semibold tracking-wide">Finish Date</th>
              <th className="p-3 md:text-xs text-[10px] font-semibold tracking-wide">Client</th>
              <th className="p-3 md:text-xs text-[10px] font-semibold tracking-wide">Price</th>
              <th className="p-3 md:text-xs text-[10px] font-semibold tracking-wide">Team</th>
              <th className="p-3 md:text-xs text-[10px] font-semibold tracking-wide">Status</th>
            </tr>
           </thead>
           <tbody>
            <tr className="border border-gray-200 ">
              ...
              <td className="border-r border-gray-200 p-3 md:text-[10px] text-[8px] font-semibold flex"><img src="./imgs/team-01.png" className=" rounded-4xl border-white border-2 md:size-6 size-5"/>
                 <img src="./imgs/team-02.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/>
                 <img src="./imgs/team-03.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/>
                 <img src="./imgs/team-05.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/></td>
            ...
            <tr className="border border-gray-200 ">
              ...
              <td className="border-r border-gray-200 p-3 md:text-[10px] text-[8px] text-gray-400 flex"><img src="./imgs/team-01.png" className=" rounded-4xl border-white border-2  md:size-6 size-5"/>
                 <img src="./imgs/team-02.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/>
                 <img src="./imgs/team-05.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/></td>
            ...
            <tr className="border border-gray-200 ">
              ...
              <td className="border-r border-gray-200 p-3 md:text-[10px] text-[8px] text-gray-400 flex ml-3">
                 <img src="./imgs/team-02.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/>
                 <img src="./imgs/team-03.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/></td>
            ...
            <tr className="border border-gray-200 ">
              ...
              <td className="border-r border-gray-200 p-3 md:text-[10px] text-[8px] text-gray-400 flex"><img src="./imgs/team-01.png" className=" rounded-4xl border-white border-2  md:size-6 size-5"/>
                 <img src="./imgs/team-02.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/></td>
              <td className="p-3 "><button className=" bg-green-500 md:text-[10px] text-[6px] text-white rounded-sm py-1 px-2">Completed</button></td>
            </tr>
            <tr className="border border-gray-200 ">
            ...
            <tr className="border border-gray-200 ">
              ...
              <td className="border-r border-gray-200 p-3 md:text-[10px] text-[8px] text-gray-400 flex"><img src="./imgs/team-01.png" className=" rounded-4xl border-white border-2  md:size-6 size-5"/>
                 <img src="./imgs/team-02.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/>
                 <img src="./imgs/team-03.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/>
                 <img src="./imgs/team-04.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-3"/></td>
              <td className="p-3 "><button className=" bg-green-500 md:text-[10px] text-[6px] text-white rounded-sm py-1 px-2">Completed</button></td>
            </tr>
           </tbody>
