    ...
    return(
          <div className="bg-white rounded-md shadow-2xl">
           ...
           <div className="flex justify-between">
            <h1 className="ml-3 mt-3 text-[10px]">Ahmed Dashboard</h1>
            <p className="text-[8px] font-semibold text-gray-400 p-1">15/6/2022</p>
           </div>
            <p className="text-[8px] mb-3 ml-3 mt-1 font-semibold text-gray-400">Ahmed Dashboard Project Design And Programming And Hosting</p>
            ...
            <hr className="text-gray-300 mx-3 my-3"></hr>
             ...
             <div className="flex justify-between mx-3 mb-2">
                ...
                <p className="text-[8px] text-gray-400 font-semibold">$ 1700</p>
             </div>
        </div>
    )
}