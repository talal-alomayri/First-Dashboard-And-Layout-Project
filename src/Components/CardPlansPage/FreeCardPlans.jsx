...
export default function CardOfAllPlans(){
   const InfoArr = [{id:1,Name:"Access All Text Lessons",     Icon:<FaCheck className="text-green-500"/>},
                    ...
                    {id:4,Name:"Browse Content Wihout Ads",   Icon:<HiOutlineX className="text-red-500"/> },
                    {id:5,Name:"Access All Assignments",      Icon:<HiOutlineX className="text-red-500"/> },
                    {id:6,Name:"Get Daily Prizes",            Icon:<HiOutlineX className="text-red-500"/> },
                    {id:7,Name:"Earn Cerificate",             Icon:<HiOutlineX className="text-red-500"/> },
