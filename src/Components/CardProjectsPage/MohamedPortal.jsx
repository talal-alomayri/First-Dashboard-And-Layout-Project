    ...
    return(
          <div className="bg-white rounded-md shadow-2xl">
           ...
           <div className="flex justify-between">
            <h1 className="ml-3 mt-3 text-[10px]">Mohamed Portal</h1>
            <p className="text-[8px] font-semibold text-gray-400 p-1">15/6/2022</p>
           </div>
            <p className="text-[8px] mb-3 ml-3 mt-1 font-semibold text-gray-400">Mohamed Portal Project Design And Programming</p>
            ...
            <hr className="text-gray-300 mx-3 my-3"></hr>
             ...
             <div className="flex justify-between mx-3 mb-2">
                 <div className="flex py-1 ">
                   <div className="bg-green-500 w-11 h-full text-[2px] rounded-2xl">-</div>
                    <div className="bg-gray-300 w-5 h-full text-[2px] rounded-r-2xl text-red-600 ">-</div>
                   </div>

                <p className="text-[8px] text-gray-400 font-semibold">$ 1650</p>
             </div>
        </div>
    )
}