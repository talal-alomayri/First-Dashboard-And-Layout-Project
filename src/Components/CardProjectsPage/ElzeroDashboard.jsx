...
export default function ElzeroDashboard(){
    return(
          <div className="bg-white rounded-md shadow-2xl">

           <div className="flex justify-between">
            <h1 className="ml-3 mt-3 text-[10px]">Elzero Dashboard</h1>
            <p className="text-[8px] font-semibold text-gray-400 p-1">15/10/2021</p>
           </div>
            <p className="text-[8px] mb-3 ml-3 mt-1 font-semibold text-gray-400">Elzero Dashboard Project Design And Programming And Hosting</p>
            ...
            <img src="./imgs/team-01.png" className=" rounded-4xl border-white border-2 md:size-6 size-5"/>
                 ...
                 <img src="./imgs/team-05.png" className=" rounded-4xl border-white border-2  md:size-6 size-5 -ml-2"/>
            </div>
            ...
            <hr className="text-gray-300 mx-3 my-3"></hr>
             ...
             <div className="flex justify-between mx-3 mb-2">
                ...
                <p className="text-[8px] text-gray-400 font-semibold">$ 2500</p>
             </div>
        </div>
    )
}